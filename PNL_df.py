...
# ---------------------------------------------------------------------
RAW_PATH      = "PNL_df.csv"
CLEANED_PATH  = "PNL_df_cleaned.csv"
RANDOM_STATE  = 42
...
# ---------------------------------------------------------------------
X_train_scaled.to_csv("X_train_scaled_PNL.csv", index=False)
X_val_scaled.to_csv("X_val_scaled_PNL.csv", index=False)
X_test_scaled.to_csv("X_test_scaled_PNL.csv", index=False)

y_train.to_csv("y_train_PNL.csv", index=False)
y_val.to_csv("y_val_PNL.csv", index=False)
y_test.to_csv("y_test_PNL.csv", index=False)
