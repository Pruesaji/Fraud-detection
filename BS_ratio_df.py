...
# 0.  CONSTANTS
# ---------------------------------------------------------------------
RAW_PATH      = "balancesheet_ratio.csv"
CLEANED_PATH  = "BS_ratio_df_cleaned.csv"
RANDOM_STATE  = 42
...
# ---------------------------------------------------------------------
X_train.to_csv("X_train_scaled_BS_ratio.csv", index=False)
X_val.to_csv("X_val_scaled_BS_ratio.csv", index=False)
X_test.to_csv("X_test_scaled_BS_ratio.csv", index=False)
