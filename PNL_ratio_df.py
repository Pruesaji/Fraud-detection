...
# 0.  CONSTANTS
# ---------------------------------------------------------------------
RAW_PATH      = "income_statement_ratio.csv"
CLEANED_PATH  = "PNL_ratio_df_cleaned.csv"
RANDOM_STATE  = 42
...
# 6. EXPORT MATRICES
# ---------------------------------------------------------------------
X_train.to_csv("X_train_scaled_PNL_ratio.csv", index=False)
X_val.to_csv("X_val_scaled_PNL_ratio_.csv", index=False)
X_test.to_csv("X_test_scaled_PNL_ratio.csv", index=False)
