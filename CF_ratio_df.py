...
# 0.  CONSTANTS
# ---------------------------------------------------------------------
RAW_PATH      = "cashflow_ratio.csv"
CLEANED_PATH  = "CF_ratio_df_cleaned.csv"
RANDOM_STATE  = 42
...
# 6. EXPORT MATRICES
# ---------------------------------------------------------------------
X_train.to_csv("X_train_scaled_CF_ratio.csv", index=False)
X_val.to_csv("X_val_scaled_CF_ratio.csv", index=False)
X_test.to_csv("X_test_scaled_CF_ratio.csv", index=False)
